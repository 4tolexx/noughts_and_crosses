defmodule TictactoeWeb.NewPlayer do
  use TictactoeWeb, :live_view

  alias TictactoeWeb.NewGame
  ...
  def mount(_params, %{"player_name" => _player_name}, socket) do
    {:ok, push_redirect(socket, to: Routes.live_path(socket, NewGame))}
  end
  ...
  def handle_event("save", %{"player" => player_params}, socket) do
    ...
    if changeset.valid? do
      ...
      {:noreply, redirect(socket, to: Routes.live_path(socket, NewGame))}
    else
