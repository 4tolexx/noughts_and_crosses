defmodule TictactoeWeb.ShowGame do
  ...
  def render(%{game: _game, error: nil} = assigns) do
    ...
    <div>
      <div class="max-w-2xl mx-auto">
        <%= live_component TictactoeWeb.BoardComponent, id: :board, game: @game, player: @player %>
      </div>
      ...
      <%= if @game.finished do %>
        <%= live_component TictactoeWeb.NewGameComponent, id: :new_game, game: @game %>
      <% end %>
    </div>
    """
  end
